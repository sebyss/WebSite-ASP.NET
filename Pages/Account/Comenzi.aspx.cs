...
public partial class Pages_Comenzi : System.Web.UI.Page
{
    ...
    public void GetcomandaInCos(string userId)
    {
        ...
        List<Co> listaComanda = cosModel.getFromCos(userId);
        CreateShopTable(listaComanda);
    ...
    public void CreateShopTable(List<Co> listaComanda)
    {
        ...
        foreach (Co cos in listaComanda)
        {
            ...
            TableCell b3 = new TableCell { Text = cos.Amount + ""};
